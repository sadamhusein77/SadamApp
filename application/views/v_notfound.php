...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/theme-assets/css/pages/error.min.css">
    <!-- END: Page CSS-->
  ...
  <body class="vertical-layout vertical-menu 1-column  bg-gradient-directional-danger blank-page blank-page" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="1-column">
            ...
            <div class="col-lg-4 col-md-6 col-10 p-0">
                ...
                <div class="card-content">
                    ...
                    <div class="row py-2 text-center">
                        <div class="col-12">
                            <a href="" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Back to Home</a>
                        </div>
                ...
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <p class="text-muted text-center col-12 py-1 white">© <span class="year"></span> <a href="#" class="white text-bold-700">Eno </a>Journal <i class="ft-heart white "> </i> </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo base_url(); ?>assets/theme-assets/vendors/js/forms/validation/jqBootstrapValidation.js" type="text/javascript"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>assets/theme-assets/js/scripts/forms/form-login-register.min.js" type="text/javascript"></script>
    <!-- END: Page JS-->
